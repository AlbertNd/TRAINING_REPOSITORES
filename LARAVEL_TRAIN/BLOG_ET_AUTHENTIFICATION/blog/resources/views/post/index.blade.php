<x-app-layout>
    ...
    <div class="overflow-x-hidden bg-gray-100">
        <!-- J'ai retirer la bar de navigation du script de base -->
        ...
        <div class="px-6 py-8">
            <div class="container flex justify-between mx-auto">
                <div class="w-full lg:w-8/12">
                    ...
                    <!-- J'ai reduit le nombre de poste de base en une seule-->
        ...
        <!-- J'ai changer le footer du script de base -->
